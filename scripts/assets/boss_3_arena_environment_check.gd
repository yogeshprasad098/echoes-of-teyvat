...
const SCENE_PATH := "res://scenes/areas/ember_fields_boss_3_arena.tscn"
...
func _run() -> void:
	...
	_expect(packed != null, "Boss 3 arena scene loads")
	if packed == null:
		_finish()
		return
...
func _check_environment_nodes(root: Node) -> void:
	...
	_expect(lava_depth != null and lava_depth.position == Vector2(0, 300), "Lava/electric depth placed behind lower floor")
...
func _check_texture_sizes() -> void:
	var expected := {
		"res://assets/map/ember_fields/boss_arenas/boss_3/boss_3_arena_backdrop.png": Vector2i(640, 360),
		"res://assets/map/ember_fields/boss_arenas/boss_3/boss_3_lava_electric_depth_layer.png": Vector2i(640, 96),
		"res://assets/platforms/ember_fields/boss_arenas/boss_3/boss_3_arena_floor_strip.png": Vector2i(640, 64),
		"res://assets/platforms/ember_fields/boss_arenas/boss_3/boss_3_boundary_wall_left.png": Vector2i(64, 360),
		"res://assets/platforms/ember_fields/boss_arenas/boss_3/boss_3_boundary_wall_right.png": Vector2i(64, 360),
		"res://assets/platforms/ember_fields/boss_arenas/boss_3/boss_3_foreground_edge.png": Vector2i(640, 48),
		"res://assets/props/ember_fields/boss_arenas/boss_3/boss_3_charged_sigil_banner.png": Vector2i(96, 160),
		"res://assets/props/ember_fields/boss_arenas/boss_3/boss_3_storm_gate_portal.png": Vector2i(160, 192),
	}
...
func _finish() -> void:
	if _failures.is_empty():
		print("RESULT: PASS Boss 3 arena environment check")
		quit(0)
		return
	for failure in _failures:
		push_error(failure)
	print("RESULT: FAIL %d Boss 3 arena environment item(s)" % _failures.size())
	quit(1)
