...
func _check_environment_nodes(root: Node) -> void:
	...
	_expect(lava_depth != null and lava_depth.position == Vector2(0, 300), "Lava/crown depth placed behind lower floor")
...
func _check_texture_sizes() -> void:
	var expected := {
		"res://assets/map/ember_fields/boss_arenas/boss_5/boss_5_arena_backdrop.png": Vector2i(640, 360),
		"res://assets/map/ember_fields/boss_arenas/boss_5/boss_5_lava_crown_depth_layer.png": Vector2i(640, 96),
		"res://assets/platforms/ember_fields/boss_arenas/boss_5/boss_5_arena_floor_strip.png": Vector2i(640, 64),
		"res://assets/platforms/ember_fields/boss_arenas/boss_5/boss_5_boundary_wall_left.png": Vector2i(64, 360),
		"res://assets/platforms/ember_fields/boss_arenas/boss_5/boss_5_boundary_wall_right.png": Vector2i(64, 360),
		"res://assets/platforms/ember_fields/boss_arenas/boss_5/boss_5_foreground_edge.png": Vector2i(640, 48),
		"res://assets/props/ember_fields/boss_arenas/boss_5/boss_5_tyrant_sigil_banner.png": Vector2i(96, 160),
		"res://assets/props/ember_fields/boss_arenas/boss_5/boss_5_final_gate_portal.png": Vector2i(160, 192),
	}
