...
func _check_texture_sizes() -> void:
	var expected := {
		"res://assets/map/ember_fields/boss_arenas/boss_1/boss_1_arena_backdrop.png": Vector2i(640, 360),
		"res://assets/map/ember_fields/boss_arenas/boss_1/boss_1_lava_depth_layer.png": Vector2i(640, 96),
		"res://assets/platforms/ember_fields/boss_arenas/boss_1/boss_1_arena_floor_strip.png": Vector2i(640, 64),
