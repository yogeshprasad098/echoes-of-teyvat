...
| `switch_1` | 1 | — | Reserved for Milestone 2 |
| `switch_2` | 2 | — | Reserved for Milestone 2 |
| `switch_3` | 3 | — | Reserved for Milestone 2 |
...
## Character Switching (Milestone 2)
Keys 1, 2, 3 are already registered in the input map as `switch_1`, `switch_2`, `switch_3` — implementation deferred to Milestone 2.
